...
Run the application with the path to a folder containing images as an argument. The application window will open, displaying the first image. The application will loop back to the first image after the last one. I used an idea from ChatGPT for better design of my program on line 27 and 43  and commented on the source. I also visited Chandanas office hours on Monday.